...
function convertCuratedAndRandom(curatedQuestion, questionNo, replays, totalOptions, totalRandom){
    const finalOptions = []
...
const evaluationQuestions = curatedQuestions.map((q, index) => {
    return(convertCuratedAndRandom(q, index+1, evaluationModel.noReplays, evaluationModel.optionsPerGuess, evaluationModel.totalRandom));
})
...
function startNewEvaluation(){
        ...
        evaluationModel.currentParticipant.questions = evaluationQuestions;
